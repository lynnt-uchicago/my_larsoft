{
  ...
  const TString saveDirectory = "/sbnd/app/users/lynnt/my_larsoft/v09_73_00/opt0_crumbs/nom_AllOpT0";
  using namespace std;
 ...
 TLine *line_crumbs_2 = new TLine(0.05,0,0.05,1.04*hNotNuSliceNomCrumbsScore->GetMaximum());
  ...
  rocLeg->AddEntry(optcrumbsROC,"OpT0 (All Vars) CRUMBS Score","lp");
  rocLeg->Draw();
  ...
  // multi_zoomed->GetXaxis()->SetNdivisions(20);
  // multi_zoomed->GetYaxis()->SetNdivisions(20);

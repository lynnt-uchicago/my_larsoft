...
pd.to_pickle(nu_df,              "/sbnd/data/users/lynnt/v09_75_03_03/df/intrnue_nu.pkl")

# remove nue events from the bnb sample
# ! because we're using a intrnue + intrnue (non intrnue), 
# ! let's try just scaling the number of signal nueCC from 
# ! intrnue by the number of signal nueCC from bnb intrnue.
# ! In this case, we keep only signal events
...
print("saving dataframes to data...")
# save everything to data 
pd.to_pickle(nu_df,           "/sbnd/data/users/lynnt/v09_75_03_03/df/intrnue_nu.pkl")
pd.to_pickle(slcpfp_nu_df,    "/sbnd/data/users/lynnt/v09_75_03_03/df/intrnue_slcpfp.pkl")
# pd.to_pickle(pre_slcpfp_nu_df,"/sbnd/data/users/lynnt/v09_75_03_03/df/intrnue_pre_slcpfp.pkl")
pd.to_pickle(slc_df,          "/sbnd/data/users/lynnt/v09_75_03_03/df/intrnue_slc_raz_opt.pkl")